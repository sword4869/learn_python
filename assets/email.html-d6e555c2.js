import{_ as e,V as p,W as o,X as n,Y as s,$ as c,Z as a,D as i}from"./framework-b4b62eb1.js";const l={},u=a(`<h1 id="email" tabindex="-1"><a class="header-anchor" href="#email" aria-hidden="true">#</a> email</h1><h2 id="send" tabindex="-1"><a class="header-anchor" href="#send" aria-hidden="true">#</a> send</h2><p>只有文字的版本</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> smtplib
